...
graph TD
    ...
    S & T -->|پارسر پاسخ| U[درخواست خام HTTP بازسازی‌شده]
...
* **[JSAnalyzer](https:// JENISH-sojitra/JSAnalyzer)**: به خاطر ساختارهای پایه و پترن‌های اولیه استخراج عبارات در جاوااسکریپت.
