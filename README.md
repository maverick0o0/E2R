...
<p align="right">
  <a href="README_FA.md">🇮🇷 نسخه فارسی (Persian Version)</a>
</p>
...
4. **Pattern & Extraction Engine**: Multi-threaded scanner engines parse the beautified code using tuned, false-positive-resistant regex patterns to identify:
