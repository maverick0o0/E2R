...
public class E2RExtension implements BurpExtension {
    ...
    public void initialize(MontoyaApi montoyaApi) {
        ...
        // Initialize the discovery store for secrets, emails, and files
        discoveryStore = new DiscoveryStore();
        
        // Create the main UI tab
        E2RTab mainTab = new E2RTab(api, endpointStore, discoveryStore);
        
        // Register the HTTP handler for passive scanning
        E2RHttpHandler httpHandler = new E2RHttpHandler(api, endpointStore, discoveryStore, mainTab);
        api.http().registerHttpHandler(httpHandler);
        
        // Register context menu for Site Map
        E2RContextMenuProvider contextMenu = new E2RContextMenuProvider(api, endpointStore, discoveryStore);
        ...
        logging.logToOutput("Detects: Endpoints, URLs, Secrets, Emails, Files");
